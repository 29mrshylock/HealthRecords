            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="doctor-card text-center">
                        <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Dr. Anil Sharma" class="rounded-circle">
                ...
                <div class="col-md-4">
                    <div class="doctor-card text-center">
                        <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Priya Patel" class="rounded-circle">
                        <div class="card-content">
                            <h4>Priya Patel</h4>
                ...
                <div class="col-md-4">
                    <div class="doctor-card text-center">
                        <img src="https://randomuser.me/api/portraits/women/65.jpg" alt="Dr. Neha Gupta" class="rounded-circle">
                        <div class="card-content">
                            <h4>Dr. Neha Gupta</h4>
